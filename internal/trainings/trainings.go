...
type Training struct {
	...
	personaldata.Personal // Встроенная структура с данными пользователя
}

// Метод парсинга строки с данными о тренировке
...
// Метод для формирования строки с данными о тренировке
